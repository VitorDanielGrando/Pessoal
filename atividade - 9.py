...
print(100*"-")
l = float(input("Insira a quantiedade de litros de refresco desejadas: "))

a = l * 8
s = l * 2

print(100*"-")
print(f"Serão necessários {a} partes de água mineral")
print(f"E serão necessárias {s} partes de suco de maracuja")
print(100*"-")